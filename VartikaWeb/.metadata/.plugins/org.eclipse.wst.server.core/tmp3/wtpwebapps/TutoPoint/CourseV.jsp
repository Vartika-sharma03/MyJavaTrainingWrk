...
<br>
		...
		<center>
				<h3>
					<font face="Times New Roman" size="4">
						<%String name=request.getParameter("name"); %><br> SUBJECT <%=name %></font>
				</h3>

				<h3>
					<font face="Times New Roman" size="4">
						<%String Desc=request.getParameter("decs"); %><br> ABOUT <%=Desc %></font>
				</h3>
			...
			//	URL url=s.;
				...
				<div id="pdf-wrapper" class="modal-content">
					<iframe src="Courses-PDF/<%=id1%>.pdf" id="showskill" scrolling="yes" height="600px" width ="100%" type="application/pdf">			 
 </iframe>

...
public class AddServiceLocator extends org.apache.axis.client.Service implements add.AddService {
    ...
    private java.lang.String Add_address = "http://localhost:8080/AjaxExampleDatabase/services/Add";
    ...
    public add.Add getAdd(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            add.AddSoapBindingStub _stub = new add.AddSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (add.Add.class.isAssignableFrom(serviceEndpointInterface)) {
                add.AddSoapBindingStub _stub = new add.AddSoapBindingStub(new java.net.URL(Add_address), this);
                _stub.setPortName(getAddWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://add", "AddService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://add", "Add"));
        }
